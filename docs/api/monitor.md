...
```Lisp
(defun GLFW:VIDMODE-WIDTH (G1067)
  ...)
```
...
```Lisp
(defun GLFW:VIDMODE-HEIGHT (G1068)
  ...)
```
...
```Lisp
(defun GLFW:VIDMODE-REDBITS (G1069)
  ...)
```
...
```Lisp
(defun GLFW:VIDMODE-GREENBITS (G1070)
  ...)
```
...
```Lisp
(defun GLFW:VIDMODE-BLUEBITS (G1071)
  ...)
```
...
```Lisp
(defun GLFW:VIDMODE-REFRESHRATE (G1072)
  ...)
```
...
```Lisp
(defun GLFW:DESTROY-GAMMARAMP (ARG1076)
  ...)
```
...
```Lisp
(defmacro GLFW:WITH-GAMMARAMP (VAR1086 ARGS1087 &BODY BODY1088)
  ...)
```
...
```Lisp
(defun GLFW:GAMMARAMP-RED (G1077 &OPTIONAL (INDEX NIL))
  ...)
```
...
```Lisp
(defun GLFW:GAMMARAMP-GREEN (G1078 &OPTIONAL (INDEX NIL))
  ...)
```
...
```Lisp
(defun GLFW:GAMMARAMP-BLUE (G1079 &OPTIONAL (INDEX NIL))
  ...)
```
...
```Lisp
(defun GLFW:GAMMARAMP-SIZE (G1080)
  ...)
```
...
```Lisp
(defun (SETF GLFW:GAMMARAMP-RED) (NEW-VALUE G1081 &OPTIONAL (INDEX NIL))
  ...)
```
...
```Lisp
(defun (SETF GLFW:GAMMARAMP-GREEN) (NEW-VALUE G1082 &OPTIONAL (INDEX NIL))
  ...)
```
...
```Lisp
(defun (SETF GLFW:GAMMARAMP-BLUE) (NEW-VALUE G1083 &OPTIONAL (INDEX NIL))
  ...)
```
...
```Lisp
(defun (SETF GLFW:GAMMARAMP-SIZE) (G1085 G1084)
  ...)
```
...
```Lisp
(defmacro DEFINE-MONITOR-CALLBACK (CALLBACK-NAME1102 (MONITOR EVENT) &BODY
                                   CALLBACK-BODY1103)
  ...)
```
